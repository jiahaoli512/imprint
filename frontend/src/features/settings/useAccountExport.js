...
// section-header hack), and the in-flight/error state. `exportFn` is
// injected (default: the real API call) so this is testable without mocking
// the whole api/client module, matching how useUser/useProfileEdit inject
// their data functions rather than importing `api` directly.
export function useAccountExport({ exportFn = api.exportAccountData } = {}) {
