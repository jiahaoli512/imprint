...
const TIERS = [
  ...
  { value: '1', unit: 'Day',    label: 'Day One',     caption: 'Freshly joined — welcome to Imprint!.', thresholdDays: 1,   c1: '#34c9ae', c2: '#1f8c76', halo: 'rgba(52,201,174,0.32)',  spin: '8s',  delay: '0s'   },
