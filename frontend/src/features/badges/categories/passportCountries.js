...
// Each entry: flag-icons code + display name + continent (drives badge color).
// Regenerate from the CSV if the list changes.
export const PASSPORT_COUNTRIES = [
  ...
  { code: "bf", name: "Burkina", continent: "Africa" },
  { code: "mm", name: "Burma (Myanmar)", continent: "Asia" },
